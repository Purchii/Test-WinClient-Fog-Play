...
- SyntheticUsersSafety, ResourceBudgetSafety, AllowedGamesSafety and ProdMetadataSafety statically check production guard fixture drift around aliases, canary duration budgets, game allowlists, production metadata, synthetic alias allowlist links and canary target allowlist consistency.
