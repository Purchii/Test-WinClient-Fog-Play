...
- GameSessionCanary, NonProdFoundation, TestabilityGaps and UpdateManifest runners reject AppData/log/cookie/DB/dump-like input path overrides before reading them.
