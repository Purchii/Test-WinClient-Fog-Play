...
- GameSessionCanary, NonProdFoundation, TestabilityGaps, UpdateManifest and BackendSmoke runners reject AppData/log/cookie/DB/dump-like input path overrides before reading them.
