...
- GameSessionCanary, NonProdFoundation, TestabilityGaps, UpdateManifest, BackendSmoke and WebViewBridge runners reject AppData/log/cookie/DB/dump-like input path overrides before reading them.
