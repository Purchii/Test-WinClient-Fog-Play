...
- direct plan validation requires an allowlisted `qa-canary-*` synthetic user alias with `prod_conditional_stream_canary` purpose, game-session permission and a matching duration ceiling;
